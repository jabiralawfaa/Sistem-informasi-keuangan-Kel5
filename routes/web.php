...
Route::middleware(['auth', 'role-check', 'role:auditor'])->group(function () {
    ...
    Route::get('/auditor/dashboard', [App\Http\Controllers\AuditorDashboardController::class, 'index'])->name('auditor.dashboard');
    ...
    Route::get('/auditor/reports/{report}/print', [ReportController::class, 'print'])->name('auditor.reports.print');
