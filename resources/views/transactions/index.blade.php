                        ...
                        <tr class="border-b border-gray-700 hover:bg-gray-750">
                            ...
                            <td class="py-3 px-4">
                                <div class="flex space-x-2">
                                    ...
                                    @else
                                    <a href="{{ route('bendahara.transactions.receipt', $transaction->id) }}" class="text-green-400 hover:text-green-300 ml-2" onclick="return confirm('Generate receipt for this transaction?')">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
