    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-8">
            ...
            @if(Auth::user()->role === 'admin')
                <a href="{{ route('admin.receipts.create') }}" class="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg transition duration-200">
                    Create New Receipt
                </a>
            @else
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-700 hover:bg-gray-750">
                            ...
                            <td class="py-3 px-4">
                                <div class="flex space-x-2">
                                    @if(Auth::user()->role === 'admin')
                                        <a href="{{ route('admin.receipts.show', $receipt) }}" class="text-blue-400 hover:text-blue-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                                <path d="M10 12a2 2 0 100-4 2 2 0 000 4z" />
                                                <path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd" />
                                            </svg>
                                        </a>
                                        <a href="{{ route('admin.receipts.print', $receipt) }}" class="text-green-400 hover:text-green-300" target="_blank">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                        ...
                                        <a href="{{ route('admin.receipts.edit', $receipt) }}" class="text-amber-400 hover:text-amber-300">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <tr>
                            <td colspan="6" class="py-8 px-4 text-center text-gray-500">
                                No receipts found.
                                @if(Auth::user()->role === 'admin')
                                    <a href="{{ route('admin.receipts.create') }}" class="text-amber-400 hover:text-amber-300">Create your first receipt</a>.
                                @else
                                    <a href="{{ route('bendahara.receipts.create') }}" class="text-amber-400 hover:text-amber-300">Create your first receipt</a>.
                                @endif
                            </td>
                        </tr>
                        @endforelse
